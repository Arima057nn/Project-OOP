...
public class Giay extends SanPham{
    ...
    public Giay(String tenSP, Double giaNhap, Double giaBan, Integer soLuong,
                String size, String mauSac, String chatLieu, String xuatXu, String kieuCoGiay, String dip, String loaiGiay) {
