...
public class Ao extends SanPham {
    ...
    public Ao(String tenSP, Double giaNhap, Double giaBan, Integer soLuong, String size, String mauSac,
              String chatLieu, String xuatXu, String coAo, String mauAo, String chieuDaiTayAo, String loaiAo) {
        super(tenSP, giaNhap, giaBan, soLuong, size, mauSac, chatLieu, xuatXu);
        this.coAo = coAo;
        this.mauAo = mauAo;
